...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { city: @park.city, fullname: @park.fullname, hours: @park.hours, statecode: @park.statecode, url: @park.url } }, as: :json
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { city: @park.city, fullname: @park.fullname, hours: @park.hours, statecode: @park.statecode, url: @park.url } }, as: :json
    assert_response 200
  end
